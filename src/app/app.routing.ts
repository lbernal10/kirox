...
export const appRoutes: Route[] = [
    ...
    // Auth routes for guests e
    {
        ...
        children: [
            ...
            {path: 'terminos-politicas', loadChildren: () => import('app/modules/auth/terminos-politicas/terminos-politicas.module').then(m => m.TerminosPoliticasModule)},
            {path: 'forgot-password', loadChildren: () => import('app/modules/auth/forgot-password/forgot-password.module').then(m => m.AuthForgotPasswordModule)},
            {path: 'reset-password/:tokenPassword', loadChildren: () => import('app/modules/auth/reset-password/reset-password.module').then(m => m.AuthResetPasswordModule)},
